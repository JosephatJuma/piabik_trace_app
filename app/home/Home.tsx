...
import { FAB,ProgressBar,Text,Banner } from "react-native-paper";
...
const Home = () => {
  ...
  const { refreshing, err, fetchItems,setErr } = useContext(ItemsContext);
  ...
  return (
    <View style={{ flex: 1, width: "100%" }}>
      ...
      visible={true}
      actions={[
        {label: 'Try Again',onPress: fetchItems,},
